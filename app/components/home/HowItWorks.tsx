    ...
    <section className="relative py-20 lg:py-32 bg-[#0A0F1C] overflow-hidden font-plus-jakarta border-b border-white/5">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-16 flex justify-center">
            <Link 
                href="/booking" 
                className="px-12 py-5 bg-white text-[#0A0F1C] rounded-2xl font-black text-xl hover:bg-cyan-400 transition-all active:scale-95 shadow-2xl hover:shadow-cyan-500/20"
            >
